...
#  setup do
#     children = [
##       Registry, [:unique, :bpm_process_registry],
#       Execution.BPMProcessEngine, [:bpm_engine]
#     ]
#
...
#     {:ok, process_id} = Engine.create_bpm_process_process(engine)
...
#
#
#   test "start a process with a business reference", %{engine: engine} do
#
#   end
end
